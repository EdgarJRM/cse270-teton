...
class TestSmokeTest():
  ...
  def test_adminPage(self):
    ...
    self.driver.set_window_size(1364, 718)
    elements = self.driver.find_elements(By.ID, "username")
    assert len(elements) > 0
    self.driver.find_element(By.ID, "username").click()
    self.driver.find_element(By.ID, "username").send_keys("shamanking55")
  ...
  def test_joinPage(self):
    ...
    self.driver.find_element(By.NAME, "fname").send_keys("Edgar")
    ...
    self.driver.find_element(By.NAME, "bizname").send_keys("Edberserk")
  ...
  def test_homePage(self):
    ...
    self.driver.set_window_size(830, 727)
